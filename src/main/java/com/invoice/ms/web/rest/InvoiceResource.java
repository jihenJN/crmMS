...
import com.invoice.ms.service.InvoiceService;
import com.invoice.ms.service.dto.InvoiceDTO;
import com.invoice.ms.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.invoice.ms.domain.Invoice}.
 */
@RestController
@RequestMapping("/api")
public class InvoiceResource {
    ...
    private static final String ENTITY_NAME = "invoicedbInvoice";
