...
import com.gateway.ms.GatewaycrmdbApp;
import com.gateway.ms.config.AsyncSyncConfiguration;
import com.gateway.ms.config.EmbeddedMongo;
...
@SpringBootTest(classes = { GatewaycrmdbApp.class, AsyncSyncConfiguration.class })
@EmbeddedMongo
